...
// Note: keep both  and instance members inline (so similar)
...
var Promise:{
     ...
     */
    new<R>(callback:(resolve:(thenable:Promise.Thenable<R>) => void, reject:(error:any) => void) => void):Promise<R>
    new<R>(callback:(resolve:(result:R) => void, reject:(error:any) => void) => void):Promise<R>
     ...
     */
    try<R>(fn:() => Promise.Thenable<R>, args?:any[], ctx?:any): Promise<R>;
    try<R>(fn:() => R, args?:any[], ctx?:any): Promise<R>;

    attempt<R>(fn:() => Promise.Thenable<R>, args?:any[], ctx?:any): Promise<R>;
    attempt<R>(fn:() => R, args?:any[], ctx?:any): Promise<R>;
     ...
     */
    // promise of array with promises of value
    settle<R>(values:Promise.Thenable<Promise.Thenable<R>[]>): Promise<Promise.Inspection<R>[]>;
    // promise of array with values
     ...
     */
    // promise of array with promises of value
    some<R>(values:Promise.Thenable<Promise.Thenable<R>[]>, count:number): Promise<R[]>;
    // promise of array with values
    ...
    join<T1, T2, V>(x:Promise<T1>, y:Promise<T2>, f:(t1:T1, t2:T2) => Promise<V>):Promise<V>;
    join<T1, T2, V>(x:Promise<T1>, y:T2, f:(t1:T1, t2:T2) => Promise<V>):Promise<V>;
    join<T1, T2, V>(x:T1, y:Promise<T2>, f:(t1:T1, t2:T2) => Promise<V>):Promise<V>;
    join<T1, T2, V>(x:Promise<T1>, y:Promise<T2>, f:(t1:T1, t2:T2) => V):Promise<V>;
    join<T1, T2, V>(x:T1, y:Promise<T2>, f:(t1:T1, t2:T2) => V):Promise<V>;
    join<T1, T2, V>(x:Promise<T1>, y:T2, f:(t1:T1, t2:T2) => V):Promise<V>;


    join<T1, T2, T3, V>(x:Promise<T1>, y:Promise<T2>, z:Promise<T3>, f:(t1:T1, t2:T2, t3:T3) => V):Promise<V>;
    join<T1, T2, T3, V>(x:Promise<T1>, y:Promise<T2>, z:Promise<T3>, f:(t1:T1, t2:T2, t3:T3) => Promise<V>):Promise<V>;
     ...
     */
    // promise of array with promises of value
    map<R, U>(values:Promise.Thenable<Promise.Thenable<R>[]>, mapper:(item:R, index:number, arrayLength:number) => Promise.Thenable<U>): Promise<U[]>;
    map<R, U>(values:Promise.Thenable<Promise.Thenable<R>[]>, mapper:(item:R, index:number, arrayLength:number) => U): Promise<U[]>;

    // promise of array with values
    map<R, U>(values:Promise.Thenable<R[]>, mapper:(item:R, index:number, arrayLength:number) => Promise.Thenable<U>): Promise<U[]>;
    map<R, U>(values:Promise.Thenable<R[]>, mapper:(item:R, index:number, arrayLength:number) => U): Promise<U[]>;
    ...
    // array with values
    map<R, U>(values:R[], mapper:(item:R, index:number, arrayLength:number) => Promise.Thenable<U>): Promise<U[]>;
    map<R, U>(values:R[], mapper:(item:R, index:number, arrayLength:number) => U): Promise<U[]>;
     ...
     */
    // promise of array with promises of value
    reduce<R, U>(values:Promise.Thenable<Promise.Thenable<R>[]>, reducer:(total:U, current:R, index:number, arrayLength:number) => Promise.Thenable<U>, initialValue?:U): Promise<U>;
    reduce<R, U>(values:Promise.Thenable<Promise.Thenable<R>[]>, reducer:(total:U, current:R, index:number, arrayLength:number) => U, initialValue?:U): Promise<U>;

    // promise of array with values
    reduce<R, U>(values:Promise.Thenable<R[]>, reducer:(total:U, current:R, index:number, arrayLength:number) => Promise.Thenable<U>, initialValue?:U): Promise<U>;
    reduce<R, U>(values:Promise.Thenable<R[]>, reducer:(total:U, current:R, index:number, arrayLength:number) => U, initialValue?:U): Promise<U>;
    ...
    // array with values
    reduce<R, U>(values:R[], reducer:(total:U, current:R, index:number, arrayLength:number) => Promise.Thenable<U>, initialValue?:U): Promise<U>;
    reduce<R, U>(values:R[], reducer:(total:U, current:R, index:number, arrayLength:number) => U, initialValue?:U): Promise<U>;
     ...
     */
    // promise of array with promises of value
    filter<R>(values:Promise.Thenable<Promise.Thenable<R>[]>, filterer:(item:R, index:number, arrayLength:number) => Promise.Thenable<boolean>): Promise<R[]>;
    filter<R>(values:Promise.Thenable<Promise.Thenable<R>[]>, filterer:(item:R, index:number, arrayLength:number) => boolean): Promise<R[]>;

    // promise of array with values
    filter<R>(values:Promise.Thenable<R[]>, filterer:(item:R, index:number, arrayLength:number) => Promise.Thenable<boolean>): Promise<R[]>;
    filter<R>(values:Promise.Thenable<R[]>, filterer:(item:R, index:number, arrayLength:number) => boolean): Promise<R[]>;
    ...
    // array with values
    filter<R>(values:R[], filterer:(item:R, index:number, arrayLength:number) => Promise.Thenable<boolean>): Promise<R[]>;
    filter<R>(values:R[], filterer:(item:R, index:number, arrayLength:number) => boolean): Promise<R[]>;
};

interface Promise<R> extends Promise.Inspection<R> {
    ...
    caught(onReject?:(error:any) => void): Promise<R>;
    ...
    catch(predicate:(error:any) => boolean, onReject:(error:any) => void): Promise<R>;
    caught(predicate:(error:any) => boolean, onReject:(error:any) => void): Promise<R>;
    ...
    catch(ErrorClass:Function, onReject:(error:any) => void): Promise<R>;
    caught(ErrorClass:Function, onReject:(error:any) => void): Promise<R>;
	...
	* });
    ...
    get<U>(propertyName:any): Promise<U>;
